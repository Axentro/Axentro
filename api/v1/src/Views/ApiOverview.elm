...
overviewAddressSection =
    ...
    , apiOverviewTable
        (Table.tbody []
            [ Table.tr []
                [ Table.td [] [ Html.text "GET" ]
                , Table.td [] [ a [ href "#api-address-transactions" ] [ Html.text "v1/address/{:address}/transactions" ] ]
                , Table.td [] [ Html.text "transactions for address" ]
                ]
            , Table.tr []
                [ Table.td [] [ Html.text "GET" ]
                , Table.td [] [ a [ href "#api-address-confirmed" ] [ Html.text "v1/address/{:address}/confirmed" ] ]
                , Table.td [] [ Html.text "confirmed amount for address for all tokens" ]
                ]
            , Table.tr []
                [ Table.td [] [ Html.text "GET" ]
                , Table.td [] [ a [ href "#api-address-confirmed-token" ] [ Html.text "v1/address/{:address}/confirmed/{:token}" ] ]
                , Table.td [] [ Html.text "confirmed amount for address for specified token" ]
                ]
            , Table.tr []
                [ Table.td [] [ Html.text "GET" ]
                , Table.td [] [ a [ href "#api-address-unconfirmed" ] [ Html.text "v1/address/{:address}/unconfirmed" ] ]
                , Table.td [] [ Html.text "unconfirmed amount for address for all tokens" ]
                ]
            , Table.tr []
                [ Table.td [] [ Html.text "GET" ]
                , Table.td [] [ a [ href "#api-address-unconfirmed-token" ] [ Html.text "v1/address/{:address}/unconfirmed" ] ]
...
overviewDomainSection =
    ...
    , apiOverviewTable
        (Table.tbody []
            [ Table.tr []
                [ Table.td [] [ Html.text "GET" ]
                , Table.td [] [ a [ href "#api-domain-transactions" ] [ Html.text "v1/domain/{:domain}/transactions" ] ]
                , Table.td [] [ Html.text "transactions for domain" ]
                ]
            , Table.tr []
                [ Table.td [] [ Html.text "GET" ]
                , Table.td [] [ a [ href "#api-domain-confirmed" ] [ Html.text "v1/domain/{:domain}/confirmed" ] ]
                , Table.td [] [ Html.text "confirmed amount for domain for all tokens" ]
                ]
            , Table.tr []
                [ Table.td [] [ Html.text "GET" ]
                , Table.td [] [ a [ href "#api-domain-confirmed-token" ] [ Html.text "v1/domain/{:domain}/confirmed/{:token}" ] ]
                , Table.td [] [ Html.text "confirmed amount for domain for specified token" ]
                ]
            , Table.tr []
                [ Table.td [] [ Html.text "GET" ]
                , Table.td [] [ a [ href "#api-domain-unconfirmed" ] [ Html.text "v1/domain/{:domain}/unconfirmed" ] ]
                , Table.td [] [ Html.text "unconfirmed amount for domain for all tokens" ]
                ]
            , Table.tr []
                [ Table.td [] [ Html.text "GET" ]
                , Table.td [] [ a [ href "#api-domain-unconfirmed-token" ] [ Html.text "v1/domain/{:domain}/unconfirmed" ] ]
