...
pageApiBlockChainHeader model =
    ...
    in
        ...
        , Grid.row []
            ...
            , Grid.col [ Col.md9 ]
                [ documentation ApiBlockchainHeader model.apiUrlB2 Nothing model.apiResponse "Blockchain Header" description "GET" "api/v1/blockchain/header" Nothing Nothing "curl -X GET -H 'Content-Type: application/json' http://testnet.sushichain.io:3000/api/v1/blockchain/header" ex model.error
                ]
            ]
        ]
