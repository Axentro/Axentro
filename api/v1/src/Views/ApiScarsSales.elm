...
pageApiScarsSales model =
    ...
    in
        ...
        , Grid.row []
            ...
            , Grid.col [ Col.md9 ]
                [ documentation ApiScarsSales model.apiUrlS1 Nothing model.apiResponse "Scars Sales" description "GET" "api/v1/scars/sales" Nothing Nothing "curl -X GET -H 'Content-Type: application/json' http://testnet.sushichain.io:3000/api/v1/scars/sales" ex model.error
                ]
            ]
        ]
