...
pageApiTransactionConfirmations model =
    ...
    in
        ...
        , Grid.row []
            ...
            , Grid.col [ Col.md9 ]
                [ documentation ApiTransactionConfirmations model.apiUrlT4 model.apiResponse "Transaction Confirmations" description "GET" "v1/transaction/confirmations" "curl -X GET -H 'Content-Type: application/json' http://testnet.sushichain.io:3000/v1/transaction/confirmations" ex
                ]
            ]
        ]
