...
pageApiTransaction model =
    ...
    in
        ...
        , Grid.row []
            ...
            , Grid.col [ Col.md9 ]
                [ documentation ApiTransaction model.apiUrlT1 model.apiResponse "Transaction" description "GET" "v1/transaction/{:id}" "curl -X GET -H 'Content-Type: application/json' http://testnet.sushichain.io:3000/v1/transaction/{:id}" ex
                ]
            ]
        ]
