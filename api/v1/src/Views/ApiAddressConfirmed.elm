...
pageApiAddressConfirmed model =
    ...
    in
        ...
        , Grid.row []
            ...
            , Grid.col [ Col.md9 ]
                [ documentation ApiAddressConfirmed model.apiUrlA2 model.apiResponse "Address Confirmed" description "GET" "v1/address/{:address}/confirmed" "curl -X GET -H 'Content-Type: application/json' http://testnet.sushichain.io:3000/v1/address/{:address}/confirmed" ex
                ]
            ]
        ]
