...
class AddMiningVersionToBlock < MG::Base
  ...
  def down : String
    ...
    CREATE TABLE blocks (
      ...
      INSERT INTO blocks SELECT idx, nonce, prev_hash, timestamp, difficulty, address, kind, public_key, signature, hash, version, hash_version, merkle_tree_root, checkpoint
