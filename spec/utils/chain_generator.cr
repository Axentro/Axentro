...
module ::Units::Utils::ChainGenerator
  ...
  class BlockFactory
    ...
    def initialize(developer_fund, skip_official_nodes, custom_official_nodes, memory_kind = MemoryKind::SINGLE)
      ...
      @node = Axentro::Core::Node.new(true, true, "bind_host", 8008_i32, nil, nil, nil, nil, nil, @node_wallet, @node_wallet.address, "", @database, developer_fund, @official_nodes, false, 20, 100, false, 512, 512, false)
