...
describe Blockchain do
  it "should create a genesis block with no transactions when no developer fund is provided" do
    ...
    node = Axentro::Core::Node.new(true, true, "bind_host", 8008_i32, nil, nil, nil, nil, nil, node_wallet, database, nil, nil, false, 20, 100, 512, 512, false)
  ...
  it "should create a genesis block with the specified transactions when developer fund is provided" do
    ...
    node = Axentro::Core::Node.new(true, true, "bind_host", 8008_i32, nil, nil, nil, nil, nil, node_wallet, database, developer_fund, nil, false, 20, 100, 512, 512, false)
    blockchain = node.blockchain
    blockchain.setup(node)
