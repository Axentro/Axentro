  ...
  describe "available_actions" do
    it "should return available actions" do
      with_factory do |block_factory, transaction_factory|
        ...
        blockchain = block_factory.blockchain
        blockchain.available_actions.should eq(["send", "hra_buy", "hra_sell", "hra_cancel", "create_token", "update_token", "lock_token", "burn_token", "create_asset", "update_asset", "lock_asset", "send_asset"])
      end
    end
  end
