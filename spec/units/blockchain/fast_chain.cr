  ...
  describe "valid_transactions_for_fast_block" do
    it "should the latest index and valid aligned transactions" do
      with_factory do |block_factory, transaction_factory|
        ...
        transaction_factory.wait_for_fast_transactions(blockchain, 3)
  ...
  describe "align_fast_transactions" do
    it "should align the fast transactions" do
      with_factory do |block_factory, transaction_factory|
        ...
        blockchain.add_transaction(transaction_factory.make_fast_send(200000000_i64))
        blockchain.add_transaction(transaction_factory.make_fast_send(200000000_i64))
        blockchain.add_transaction(transaction_factory.make_fast_send(200000000_i64))

        transaction_factory.wait_for_fast_transactions(blockchain, 4)

        pp coinbase_transaction = blockchain.embedded_fast_transactions

        # pp blockchain.embedded_fast_transactions
        pp blockchain.align_fast_transactions(coinbase_transaction.first, 1)
        # .size.should eq(2)
      end
    end
  end
